...
(function(global) {
    ...
    const defaults = {
        ...
        attendanceLogs: (function() {
            const logs = [];
            // 邱冠英、郭怡蘭 23 天, 231.5 小時
            const qiuGuoDates = [
                { d: "2026-06-04", h: 10 }, { d: "2026-06-05", h: 10 }, { d: "2026-06-06", h: 10 },
                { d: "2026-06-08", h: 10 }, { d: "2026-06-09", h: 10 }, { d: "2026-06-10", h: 10 },
                { d: "2026-06-11", h: 10 }, { d: "2026-06-12", h: 12, n: "加班4小時 (08:58 - 21:01)" },
                { d: "2026-06-13", h: 9, n: "週六加班1小時 (08:58 - 18:01)" }, { d: "2026-06-15", h: 10 },
                { d: "2026-06-16", h: 10 }, { d: "2026-06-17", h: 10 }, { d: "2026-06-18", h: 10 },
                { d: "2026-06-19", h: 12, n: "端午節加班 (08:58 - 21:01)" }, { d: "2026-06-20", h: 10 },
                { d: "2026-06-22", h: 10 }, { d: "2026-06-23", h: 10 }, { d: "2026-06-24", h: 10 },
                { d: "2026-06-25", h: 10 }, { d: "2026-06-26", h: 10 }, { d: "2026-06-27", h: 10 },
                { d: "2026-06-29", h: 10 }, { d: "2026-06-30", h: 8.5 }
            ];
            // 萬昱賢 8 天, 83 小時
            const wanDates = [
                { d: "2026-06-22", h: 10 }, { d: "2026-06-23", h: 10 }, { d: "2026-06-24", h: 10 },
                { d: "2026-06-25", h: 10 }, { d: "2026-06-26", h: 11 }, { d: "2026-06-27", h: 10 },
                { d: "2026-06-29", h: 11 }, { d: "2026-06-30", h: 11 }
            ];
            
            qiuGuoDates.forEach(x => {
                logs.push({ date: x.d, foreman: "羅玉軒", name: "邱冠英", site: "村田機械", zone: "6S整理整頓", hours: x.h, note: x.n || "正常工時" });
                logs.push({ date: x.d, foreman: "羅玉軒", name: "郭怡蘭", site: "村田機械", zone: "6S整理整頓", hours: x.h, note: x.n || "正常工時" });
            });

            wanDates.forEach(x => {
                logs.push({ date: x.d, foreman: "羅玉軒", name: "萬昱賢", site: "村田機械", zone: "6S整理整頓", hours: x.h, note: "正常工時" });
            });
        ...
        accountsDb: [
            { empId: "admin", name: "羅玉軒", password: "admin123", role: "最高系統管理員 / 總裁", otpEnabled: true, authorizedModules: ["func_ai_asset_ingestion", "base_brand", "base_hr", "func_employee_cards", "func_work_dispatch", "func_attendance", "func_group_insurance", "func_internal_acc", "func_external_acc", "func_e_invoicing", "func_board_meeting", "func_line_hub", "func_billing_payroll", "base_permissions", "func_recruitment"] },
            { empId: "0937581112", name: "羅玉軒", password: "admin", role: "最高系統管理員 / 總裁", otpEnabled: true, authorizedModules: ["func_ai_asset_ingestion", "base_brand", "base_hr", "func_employee_cards", "func_work_dispatch", "func_attendance", "func_group_insurance", "func_internal_acc", "func_external_acc", "func_e_invoicing", "func_board_meeting", "func_line_hub", "func_billing_payroll", "base_permissions", "func_recruitment"] },
